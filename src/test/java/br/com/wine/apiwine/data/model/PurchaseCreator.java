...
//        purchase1OfClient1.setItens(new Wine[] {fakeWines[0], fakeWines[1]});
...
//        purchase2OfClient1.setItens(new Wine[] {fakeWines[1], fakeWines[2]});
...
//        purchase1OfClient2.setItens(new Wine[] {fakeWines[0], fakeWines[1], fakeWines[2]});
...
//        purchase2OfClient2.setItens(new Wine[] {fakeWines[0], fakeWines[1]});
...
//        purchase3OfClient2.setItens(new Wine[] {fakeWines[0], fakeWines[2]});
...
//        purchase4OfClient2.setItens(new Wine[] {fakeWines[0]});
...
//        purchase5OfClient2.setItens(new Wine[] {fakeWines[0]});
...
//        purchase1OfClient3.setItens(new Wine[] {fakeWines[0]});
...
//        purchase2OfClient3.setItens(new Wine[] {fakeWines[0]});
...
//        purchase3OfClient3.setItens(new Wine[] {fakeWines[0]});
...
//        purchase4OfClient3.setItens(new Wine[] {fakeWines[0]});
...
//        purchase1OfClient4.setItens(new Wine[] {fakeWines[0]});
...
//        purchase2OfClient4.setItens(new Wine[] {fakeWines[0]});
...
//        purchase1OfClient6.setItens(new Wine[] {fakeWines[0]});
